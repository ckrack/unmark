...
class PocketImport extends NetscapeImport
{
    /**
    ...
    public function importFile($filePath)
    {
        ...
        foreach ($this->tmpFile->getElementsByTagName('a') as $node) {
            ...
            $markObj->created_on = date("Y-m-d H:i:s", $node->getAttribute("time_added"));
            $markObj->embed = null;
    ...
    public function validateUpload($uploadedFile)
    {
        ...
        $nodeList = $XPath->evaluate("//title[text()[contains(.,'Pocket')]]");
